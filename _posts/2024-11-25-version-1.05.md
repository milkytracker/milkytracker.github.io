...
> NOTE: the classic UI can still be enabled in <b>config</b> &gt; <b>layout<b> &gt; <b>classic UI</b>:
...
Ok that was not true, there's another gift: download the <a href="files/milkypack01.xm" target="_blank">milkysynth pack for free!</b>:

![Image](https://i.imgur.com/4zIDpnE.png){: width="300" }

<br>

A nice pack with intrument patches, including one HG Fortune instrument (RIP) because no pack should live without it.<br>
Almost all these instrument patches have been designed with milkysynth, ready to use for preset/designer-musicians who don't like synth-fiddling.
